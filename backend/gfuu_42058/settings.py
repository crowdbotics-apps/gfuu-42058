"""
Django settings for gfuu_42058 project.
...
WSGI_APPLICATION = 'gfuu_42058.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gfuu_42058 API",
    "DESCRIPTION": "API documentation for gfuu_42058 App",
    "VERSION": "v1",
}
